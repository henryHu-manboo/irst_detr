...
class SwinTransformerBlock3D(nn.Module):
    def __init__(self, c1, drop_path_rate, num_frames=5, num_layers=2, num_heads_=64):
        super().__init__()
        num_heads = c1 // num_heads_
        ...
        self.tr = nn.Sequential(*(SwinTransformerLayer3D(c1, num_heads=num_heads, window_size=self.window_size,
                                                         ...
                                                         drop_path=self.drop_path[i]) for i in range(num_layers)))
