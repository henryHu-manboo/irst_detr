...
if __name__ == "__main__":
    model = PResNet(depth=18, freeze_at=-1, freeze_norm=False, pretrained=False, num_stages=1)
    x = torch.randn(5,1,640,640)
    x = model(x)
    print(x.shape)
